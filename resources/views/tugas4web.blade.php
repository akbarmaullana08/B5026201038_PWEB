<head>
    ...
    <form name='registration' id="contact" method="post" action="google.php" onsubmit="return verifyPassword()">
        <!-- User_Id -->
        <div>
            <label for="userid">User id:</label>
            <input type="text" id="usid" name="user_id" pattern=.{5,12} title="user id must be 5 to 12 in length" size="50" required></input>
        <span class="error" style="color: red;"><i>user id must be 5 to 12 in length</i></span>
        </div>
      <!--Password -->
        <div>
      ...
      <!-- About -->
        <div>
            <label for="contact_message">About:</label>
            <textarea id="contact_message" name="message" cols="50"></textarea>
        </div>
      <!-- Submit Button -->
